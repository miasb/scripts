...
my $temp_sweep = Sweep('Temperature', {
	...
	pid => [(180, 1, 0.5)], #kryo mit wenig helium: 90, 1, 0.5; oder 100, 2.5, 0.25?? oder 100, 1.5, 0.3, 100, 1.8, 0.25
	
	stabilize_observation_time => 5*60,		
	tolerance_setpoint => 0.050, #gilt fürs ITC			
	std_dev_instrument => 0.025, #gilt fürs ITC				
	std_dev_sensor => 0.05, #gilt fürs lakeshore
});
